...
class UpdateForm extends React.Component {
      ...
      axios.put(`${USER_URL.update}?primaryPhone=${store.user.phone} `, this.state)
      .then(response => {
          console.log(response);
          ...
          if (response.status === 200 && resdata[1] === "Successfull") {
              store.notification = {
                  type: 'success',
                  message: `Phone no   ${store.user.phone}  ${response.data.status}  `,
                                ...
                                <form className="form-container" onSubmit={this.submitHandler.bind(this)} >
                                        ...
                                        <div className="group-form-container">
                                                ...
                                                <div className="form-group">
                                                                ...
                                                                <input className="form-item" type="text" name="phone" disabled formNoValidate  value={store.user.phone} onChange={this.changeHandler} />
                                                        </div>
